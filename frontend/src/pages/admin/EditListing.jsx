...
const EditListing = () => {
  ...
  return (
    <Container style={{ position: "relative", background: "#f7f7f7" }}>
      <button
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 0" }}>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            >
              Existing images will be kept. Upload new images to add to the
              collection.
            </p>
              ...
              style={{
                ...
                padding:
                  uploadedImages.length === 0 && existingImages.length === 0
                    ...
                    : "0",
                justifyContent:
                  uploadedImages.length === 0 ? "center" : "flex-start",
                alignItems: "center",
                backgroundColor:
                  uploadedImages.length === 0 && existingImages.length === 0
                    ? "#fafafa"
